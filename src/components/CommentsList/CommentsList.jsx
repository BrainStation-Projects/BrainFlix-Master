...
function CommentsList({ currentVideo, API_URL, setComments }) {
    ...
    return (
        <div className="comments">
            ...
            {comments.sort((a, b) => parseInt(b.timestamp) - parseInt(a.timestamp)).map((comment) => {
                ...
                return <Comment key={comment.id} videoId={currentVideo.id} commentId={comment.id} user={comment.name} comment={comment.comment} date={date} API_URL={API_URL} setComments={setComments} />
            })}
